...
#import "DQPhotoCollectionController.h"
#import "DQImageScrollView.h"
#import "DQPhotoCollectionCell.h"
#import "DQPhotoLoader.h"
#import "DQPhoto.h"
#import "DQPhotoAlbumList.h"

@interface DQPhotoCollectionController ()<UICollectionViewDataSource, UICollectionViewDelegate>
{
...
@property (strong, nonatomic) DQImageScrollView *imageScrollView;
@property (strong, nonatomic) NSArray<DQPhoto *> *allPhotos;

@property (nonatomic, strong) NSArray<DQPhotoAlbumList *> *AlbumListArray;

@end

@implementation DQPhotoCollectionController

static NSString *CellIdentifier = @"DQPhotoCollectionCell";
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    DQPhotoCollectionCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:CellIdentifier forIndexPath:indexPath];
    DQPhoto *photo = [self.allPhotos objectAtIndex:indexPath.row];
...
- (void)loadPhotos {
//    
//    self.AlbumListArray = [[DQPhotoLoader sharePhotoLoader] getPhotoAblumList];
//    
//    NSMutableArray *tempArray = [NSMutableArray array];
//    
//    for (DQPhotoAlbumList *photoAlbum in self.AlbumListArray) {
//        if ([photoAlbum.title isEqualToString:@"相机胶卷"] || [photoAlbum.title isEqualToString:@"Camera Roll"]) {
//            NSArray<PHAsset *> *assets =  [[DQPhotoLoader sharePhotoLoader]getAssetsInAssetCollection:photoAlbum.assetCollection ascending:YES];
//            
//            for (PHAsset *asset in assets) {
//                DQPhoto *photo = [DQPhoto new];
//                photo.asset = asset;
...
//        self.topView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleBottomMargin;
        ...
        self.imageScrollView = [[DQImageScrollView alloc] initWithFrame:rect];
...
- (UICollectionView *)collectionView {
    if (_collectionView == nil) {
        ...
        [_collectionView registerClass:[DQPhotoCollectionCell class] forCellWithReuseIdentifier:@"DQPhotoCollectionCell"];
    }
